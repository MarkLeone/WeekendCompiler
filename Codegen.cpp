...
{
public:
    CodegenBase(LLVMContext* context,
		Module* module) :
	m_context(context),
	m_module(module),
	m_builder(*context),
...
{
public:
    CodegenExp(LLVMContext* context,
	       Module* module) :
	...
	return reinterpret_cast<Value*>
	    (const_cast<Exp&>(exp).Dispatch(*this)); 
    }
    
    void* Visit(ConstantExp& exp) override
    {
	return m_utils.MakeInt32(exp.GetValue());
    }
...
{
public:
    CodegenStmt(LLVMContext* context,
		Module* module) :
	CodegenBase(context, module)
    {
    }
...
{
public:
    CodegenFunc(LLVMContext* context,
		Module* module) :
	CodegenBase(context, module)
    {
    }
